                                  ...
                                  children:[
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: const InputDecoration(
                                        hintText: "Enter new admin's email",
                                                    ...
                                                    BackdropFilter(
                                                      ...
                                                      child: AlertDialog(
                                                        ...
                                                        title: Column(
                                                          children: [
                                                            Text(
                                                              "Are you sure to add $email as admin to database?",
                                                              style: TextStyle(
                                                                fontSize: mqh*0.023,
                                                                color:Colors.black,
                                                              ),
                                                            ...
                                                            Text(
                                                              "(On registering $email can choose between the admin and patient role)",
                                                              style: TextStyle(
                                                                fontSize: mqh*0.018,
                                                                color:Colors.black,
                                                              ),
                                                        ...
                                                        actions: [
                                                          Row(
                                                            ...
                                                            children: [
                                                              TextButton(
                                                                onPressed: ()async{
                                                                  await FirebaseFirestore.instance.collection('admin').doc(username.toLowerCase()).
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "(this may contain those admins, added by the admin but not registered by themselves)",
                                          style:TextStyle(
                                            fontSize: mqh*0.017,
                                            color: Colors.black,
                                          ),
